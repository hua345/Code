...
public class ThreadLocalHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
	...
	public ThreadLocalHystrixConcurrencyStrategy(Collection<HystrixCallableWrapper> wrappers) {
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		return new ThreadLocalHystrixConcurrencyStrategy.CallableWrapperChain<>(callable, wrappers.iterator()).wrapCallable();
	}
