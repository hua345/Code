...
@Slf4j
@Component
@ImportStrategy(strategyCode = "test_importSchool")
public class TestImportStrategySchool extends AbstractImportRowTemplate {
    public TestImportStrategySchool() {
    ...
    public AbstractModelAnalysisEventListener<Map<Integer, String>> defaultAnalysisListener(ImportDataBo importDataBo) {
        ...
        return new AbstractModelWriteFileAnalysisEventListener<Map<Integer, String>>(false) {
